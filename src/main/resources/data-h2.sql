...
----seatcinemahall
insert into CINEMA_HALL_SEATS values (2,1);
insert into CINEMA_HALL_SEATS values (2,2);
insert into CINEMA_HALL_SEATS values (2,3);
insert into CINEMA_HALL_SEATS values (2,4);
insert into CINEMA_HALL_SEATS values (2,5);
